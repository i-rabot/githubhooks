# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in githubhooks.
...
import githubhooks
from githubhooks import model, lib
...
base_config.package = githubhooks
...
base_config.model = githubhooks.model
base_config.DBSession = githubhooks.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "f4c0b7e9-cdb8-4612-bfd0-5d57e1e052f8"
